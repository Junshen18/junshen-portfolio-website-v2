...
export default function HeroSection() {
  return (
    <>
      <div className="flex flex-col justify-center md:flex-row lg:p-5 2xl:p-12 md:justify-between items-center h-screen rounded-[20px] w-full">
      <div className="pr-7 md:hidden">
        ...
        <div
          className="flex flex-col gap-10 2xl:gap-14 pl-7"
        >
          <div>
        ...
        <div className="pr-7 hidden md:block">
          <Image
            ...
            height={667}
            alt="my-picture"
            className="rounded-2xl xl:h-[570px] xl:w-[428px] 2xl:h-[667px] 2xl:w-[493px]"
          />
        </div>
      </div>
    </>
